...
initialModel =
    ...
    , commandBarPosition = Position 200 200
    }
...
update msg model =
    case msg of
        ...
        MarkdownMouseUp ->
            ...
            in
                ( { model | commandBarPosition = model.mousePosition }, Cmd.none )
...
view model =
    div [ class "flex" ]
        [ sampleArticle
        , div [ commandBarStyle model ] [ text "Hello" ]
        ]
...
commandBarStyle : Model -> Attribute Msg
commandBarStyle model =
    style
        [ ( "position", "absolute" )
        , ( "left", (toPixel model.commandBarPosition.x) )
        , ( "top", (toPixel model.commandBarPosition.y) )
...
sampleArticle : Html Msg
sampleArticle =
    Markdown.toHtml [ class "markdown", onMouseUp MarkdownMouseUp ] """
# Design Principles
